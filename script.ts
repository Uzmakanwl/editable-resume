...
const generate = document.getElementById("Generate button") as HTMLElement
generate.addEventListener('click',()=>{
   let displayresume= document.getElementById('resumeOutput')as HTMLElement
...
function handleFormSubmit(event: Event): void {
    ...
    const resumeOutputElement = document.getElementById("outputDetail");
...
function toggleEditMode(): void {
    ...
    if (editButton.textContent === "Edit") {
        ...
        editButton.style.backgroundColor="#8741c4"
